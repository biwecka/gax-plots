...
cfg_name <-
    "cfg_P:1000_MR:0.0100_SE:trn-8_CX:ord_MU:uni-sw_RE:eli-abs-1_TE:g-100000-ov-0___dyn_var-mut-rate-target-mean-sin-1.8-1-0.6-1000"
...
ggsave(
    file.path(
        ...
        instance,
        alg_name,
        "indirect_dynamic_succ_median.png"
    ),
    plot = plot,
    device = "png",
    create.dir = TRUE,
