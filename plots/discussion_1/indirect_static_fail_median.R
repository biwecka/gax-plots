...
cfg_name <-
    "cfg_P:1000_MR:0.0100_SE:trn-4_CX:ord_MU:uni-sw_RE:eli-abs-1_TE:g-100000-ov-0"
...
successful_runs <- runs[success == FALSE]
...
ggsave(
    file.path(
        ...
        instance,
        alg_name,
        "indirect_static_fail_median.png"
    ),
    plot = plot,
    device = "png",
    create.dir = TRUE,
